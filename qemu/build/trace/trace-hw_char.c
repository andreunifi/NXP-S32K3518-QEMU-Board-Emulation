...
uint16_t _TRACE_NXP_UART_IRQ_STATE_DSTATE;
uint16_t _TRACE_NXP_UART_READ_DSTATE;
uint16_t _TRACE_NXP_UART_READ_FIFO_DSTATE;
uint16_t _TRACE_NXP_UART_WRITE_DSTATE;
uint16_t _TRACE_NXP_UART_CAN_RECEIVE_DSTATE;
uint16_t _TRACE_NXP_UART_FIFO_RX_PUT_DSTATE;
uint16_t _TRACE_NXP_UART_FIFO_RX_FULL_DSTATE;
uint16_t _TRACE_NXP_UART_BAUDRATE_CHANGE_DSTATE;
uint16_t _TRACE_NXP_UART_RECEIVE_DSTATE;
...
TraceEvent _TRACE_NXP_UART_IRQ_STATE_EVENT = {
    .id = 0,
    .name = "nxp_uart_irq_state",
    .sstate = TRACE_NXP_UART_IRQ_STATE_ENABLED,
    .dstate = &_TRACE_NXP_UART_IRQ_STATE_DSTATE 
};
TraceEvent _TRACE_NXP_UART_READ_EVENT = {
    .id = 0,
    .name = "nxp_uart_read",
    .sstate = TRACE_NXP_UART_READ_ENABLED,
    .dstate = &_TRACE_NXP_UART_READ_DSTATE 
};
TraceEvent _TRACE_NXP_UART_READ_FIFO_EVENT = {
    .id = 0,
    .name = "nxp_uart_read_fifo",
    .sstate = TRACE_NXP_UART_READ_FIFO_ENABLED,
    .dstate = &_TRACE_NXP_UART_READ_FIFO_DSTATE 
};
TraceEvent _TRACE_NXP_UART_WRITE_EVENT = {
    .id = 0,
    .name = "nxp_uart_write",
    .sstate = TRACE_NXP_UART_WRITE_ENABLED,
    .dstate = &_TRACE_NXP_UART_WRITE_DSTATE 
};
TraceEvent _TRACE_NXP_UART_CAN_RECEIVE_EVENT = {
    .id = 0,
    .name = "nxp_uart_can_receive",
    .sstate = TRACE_NXP_UART_CAN_RECEIVE_ENABLED,
    .dstate = &_TRACE_NXP_UART_CAN_RECEIVE_DSTATE 
};
TraceEvent _TRACE_NXP_UART_FIFO_RX_PUT_EVENT = {
    .id = 0,
    .name = "nxp_uart_fifo_rx_put",
    .sstate = TRACE_NXP_UART_FIFO_RX_PUT_ENABLED,
    .dstate = &_TRACE_NXP_UART_FIFO_RX_PUT_DSTATE 
};
TraceEvent _TRACE_NXP_UART_FIFO_RX_FULL_EVENT = {
    .id = 0,
    .name = "nxp_uart_fifo_rx_full",
    .sstate = TRACE_NXP_UART_FIFO_RX_FULL_ENABLED,
    .dstate = &_TRACE_NXP_UART_FIFO_RX_FULL_DSTATE 
};
TraceEvent _TRACE_NXP_UART_BAUDRATE_CHANGE_EVENT = {
    .id = 0,
    .name = "nxp_uart_baudrate_change",
    .sstate = TRACE_NXP_UART_BAUDRATE_CHANGE_ENABLED,
    .dstate = &_TRACE_NXP_UART_BAUDRATE_CHANGE_DSTATE 
};
TraceEvent _TRACE_NXP_UART_RECEIVE_EVENT = {
    .id = 0,
    .name = "nxp_uart_receive",
    .sstate = TRACE_NXP_UART_RECEIVE_ENABLED,
    .dstate = &_TRACE_NXP_UART_RECEIVE_DSTATE 
};
...
TraceEvent *hw_char_trace_events[] = {
    ...
    &_TRACE_NXP_UART_IRQ_STATE_EVENT,
    &_TRACE_NXP_UART_READ_EVENT,
    &_TRACE_NXP_UART_READ_FIFO_EVENT,
    &_TRACE_NXP_UART_WRITE_EVENT,
    &_TRACE_NXP_UART_CAN_RECEIVE_EVENT,
    &_TRACE_NXP_UART_FIFO_RX_PUT_EVENT,
    &_TRACE_NXP_UART_FIFO_RX_FULL_EVENT,
    &_TRACE_NXP_UART_BAUDRATE_CHANGE_EVENT,
    &_TRACE_NXP_UART_RECEIVE_EVENT,
